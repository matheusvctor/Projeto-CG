...
def carregar_imagem(caminho: str | Path) -> ImagemNetpbm:
    # leitura: suporta o parser nativo NetPBM (P1 para binario, P2 e P5 para niveis de cinza)
    ...
    with caminho_imagem.open("rb") as arquivo:
        ...
        if identificador not in FORMATOS_SUPORTADOS:
            raise ValueError(f"Formato '{identificador}' nao suportado. Utilize arquivos NetPBM (.pgm ou .pbm).")
        ...
        # P5 - Formato binario bruto em escala de cinza
...
def salvar_imagem(
    ...
    *,
    ...
    # saida: grava exclusivamente nos formatos NetPBM (P1, P2 ou P5)
